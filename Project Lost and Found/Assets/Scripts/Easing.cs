...
public static class Easing 
{
    ...
    public static Vector2 EaseVecTwo(Equation equation, float t, Vector2 b, Vector2 c, float d)
    {
        Vector2 start = b - b;
        Vector2 end = c - b;
        return  new Vector2(Ease(equation, t, start.x, end.x, d), Ease(equation, t, start.y, end.y, d));
    }
}
